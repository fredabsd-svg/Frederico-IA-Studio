...
export default function App({ user } = {}) {
  ...
  return <div className={`app workspace-${workspace} ${sideHidden ? 'sideHidden' : ''}`}>
    ...
    <Sidebar
      user={user}
      conversations={conversations} allConvs={allConvs} current={current} runs={runs}
      openConversation={openConversation} startNewChat={startNewChat} deleteConversation={deleteConversation}
      clients={clients} clientId={clientId} switchClient={switchClient} addClient={addClient} removeClient={removeClient}
      menuOpen={menuOpen} setMenuOpen={setMenuOpen}
      sideHidden={sideHidden} toggleSide={toggleSide}
      convFilter={convFilter} setConvFilter={setConvFilter}
      sideScrollRef={sideScrollRef}
      workspace={workspace}
      ...
      tasksActive={tasksActive} tasks={tasks}
      onPollTasks={pollTasks}
      onSignOut={signOut}
    />
    ...
    {designOpen && <Suspense fallback={<PanelFallback/>}><LazyDesignPanel onClose={() => setDesignOpen(false)} model={model} allModels={allModels} askConfirm={askConfirm} /></Suspense>}
