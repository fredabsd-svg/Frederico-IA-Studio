...
export const RESPONSE_TRUNCATED_REPAIR_NOTE = 'A resposta anterior foi cortada pelo limite de tamanho antes de ser concluída. Continue exatamente de onde parou, sem repetir o que já foi dito. Termine o trabalho de forma verificável antes de responder ao usuário.';
export const RESPONSE_TRUNCATED_NOTICE = '\n\n_Nota: a resposta foi interrompida pelo limite do modelo antes de terminar. Tente continuar com uma nova mensagem ou escolha um modelo com saída maior._';
